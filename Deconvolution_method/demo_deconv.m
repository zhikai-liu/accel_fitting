...
while 1
    ...
    results(count).LM=get_local_maxima_above_threshold(results(count).D_fs,3.2*std(results(count).D_fs),1);
...
clust_index(clust_index==2)=5;
clust_index(clust_index==3)=2;
clust_index(clust_index==5)=3;
