...
for i =1:length(f_mat)
    ...
    if strcmp(S.type{1},'EPSC')
        ...
        [event_index,event_peak,amps,der_index] = EPSC_detection(S.Data(:,1),S.si,amp_thre,if_2der,diff_gap,diff_thre,event_duration);
        save(f_mat(i).name,'event_index','event_peak','amps','der_index','-append');
    end
